...
public class WorkWithFile {
    ...
    private String generateReport(String dataFromFile) {
        ...
        generatedReport.append(SUPPLY_CONST).append(SPLIT_OPERATOR).append(totalSupply)
                .append(LINE_SEPARATOR).append(BUY_CONST).append(SPLIT_OPERATOR).append(totalBuy)
