...
public class WorkWithFile {
    ...
    public void getStatistic(String fromFileName, String toFileName) {
        ...
        String report = getReportToFile(dataFromFile);
    ...
    private String getReportToFile(String fromFileName) {
        StringBuilder stringBuilder = new StringBuilder();
        String[] dataSplit = fromFileName.split(" ");
        int supply = 0;
        int buy = 0;
        int result = 0;
        ...
        for (String word : dataSplit) {
            ...
            if (arrayDataSplit[0].equals("supply")) {
                supply = supply + Integer.parseInt(arrayDataSplit[1]);
            } else {
                buy = buy + Integer.parseInt(arrayDataSplit[1]);
            }
            result = supply - buy;
        }
