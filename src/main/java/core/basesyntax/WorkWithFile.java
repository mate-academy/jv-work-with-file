...
public class WorkWithFile {
    ...
    public void getStatistic(String fromFileName, String toFileName) {
        String string = getString(fromFileName);
        String[] result = resultString(string).split(SPACE);
    ...
    private String getString(String fromFileName) {
    ...
    private String resultString(String date) {
        int supply = 0;
        int buy = 0;
        String[] split = date.split(REGEX);
