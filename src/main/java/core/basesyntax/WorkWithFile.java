...
public class WorkWithFile {
    ...
    public void getStatistic(String fromFileName, String toFileName) {
        ...
        String summarisedData = summariseStats(data);
        writeToFile(summarisedData, toFileName);
    }
    ...
    private String summariseStats(String file) {
        ...
        for (String line : dataFromFile) {
            ...
            int amount = Integer.parseInt(splitWords[AMOUNT_INDEX]);
            String operation = splitWords[OPERATION_INDEX];
