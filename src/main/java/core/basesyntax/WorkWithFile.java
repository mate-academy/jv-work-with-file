...
public class WorkWithFile {
    ...
    private String countStatistic(String[] strings) {
        ...
        for (String string : strings) {
            String[] operation = string.split(COMA);
        ...
        return new StringBuilder()
                .append(SUPPLY_OPERATION_TYPE).append(COMA)
                .append(supplyAmount).append(System.lineSeparator())
                .append(BUY_OPERATION_TYPE).append(COMA)
                .append(buyAmount).append(System.lineSeparator())
                .append(RESULT).append(COMA).append(resultAmount)
                .toString();
    }
